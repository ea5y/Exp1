...
using XUI.PowerupDirection;


[DisallowMultipleComponent]
[RequireComponent(typeof(PowerupDirectionView))]
public class GUIPowerupDirection : Singleton<GUIPowerupDirection>
{
	#region === Field ===
	...
	/// </summary>
	[SerializeField]
	private PowerupDirectionView viewAttach = null;
	...
	[SerializeField]
	private GUIPowerupDirectionText directionText = null;
	...
	private PowerupDirectionView ViewAttach { get { return viewAttach; } }
	...
	private void Construct()
	{
		...
		// コントローラー生成
		var controller = new Controller(model, view, effectDirection, directionText, CharaIcon);
	...
	/// 開く
	/// </summary>
	public static void Open(PowerupDirectionParam param, Action closeCallback)
	{
		if(Instance != null){
	...
	private void _Open(PowerupDirectionParam param, Action closeCallback)
	{
	...
	/// 初期設定
	/// </summary>
	private void Setup(PowerupDirectionParam param, Action closeCallback)
	{
		if (this.Controller != null){
	...
	{
		public PowerupDirectionParam directionParam;
