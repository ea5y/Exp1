...
using XUI.SynchroDirection;


[DisallowMultipleComponent]
[RequireComponent(typeof(SynchroDirectionView))]
public class GUISynchroDirection : Singleton<GUISynchroDirection>
{
	#region === Field ===
	...
	/// </summary>
	[SerializeField]
	private SynchroDirectionView viewAttach = null;
	...
	[SerializeField]
	private GUISynchroDirectionText directionText = null;
	...
	private SynchroDirectionView ViewAttach { get { return viewAttach; } }
	...
	private void Construct()
	{
		...
		// コントローラー生成
		var controller = new Controller(model, view, effectDirection, directionText, tweenSync);
	...
	/// 開く
	/// </summary>
	public static void Open(SynchroDirectionParam param, Action closeCallback)
	{
		if (Instance != null){
	...
	private void _Open(SynchroDirectionParam param, Action closeCallback)
	{
	...
	/// 初期設定
	/// </summary>
	private void Setup(SynchroDirectionParam param, Action closeCallback)
	{
		if (this.Controller != null){
	...
	{
		public SynchroDirectionParam directionParam;
