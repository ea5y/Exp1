...
[RequireComponent( typeof( CharaShopItemPageListView ) )]
public class GUICharaShopItemPageList : MonoBehaviour {
	...
	/// </summary>
	[SerializeField]
	private CharaShopItemPageListView viewAttach = null;

	/// <summary>
	/// スクロールビュー設定
	/// </summary>
	[SerializeField]
	private GUICharaShopItemScrollView itemScrollView = null;
	...
	/// ビュー
	/// </summary>
	private CharaShopItemPageListView ViewAttach { get { return viewAttach; } }
	...
	public void SetViewCharaShopItemInfoList( List<CharaShopItemInfo> infos ) {
