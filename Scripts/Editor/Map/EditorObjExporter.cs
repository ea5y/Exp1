...
//	[MenuItem ("Scm/Map/Export/3: ExportObj To SeparateOBJFile")]
...
//			EditorUtility.DisplayDialog("Objects exported", exportedObjects + "個  ->game->ExportedObj にOBJ保存したよ", "");
//		else
//			EditorUtility.DisplayDialog("Objects not exported", "Make sure at least some of your selected objects have mesh filters!", "");
//	}

	[MenuItem ("Scm/Map/Export/1: ExportObj SeparateOBJFile")]
	...
	[MenuItem ("Scm/Map/Export/2: ExportObj MargeMesh")]
	static void ExportWholeSelectionToSingle()
	{
		...
		if (exportedObjects > 0)
		{
			...
			string filename = UnityEditor.SceneManagement.EditorSceneManager.GetActiveScene().name + "_" + exportedObjects;
			...
			EditorUtility.DisplayDialog("Objects exported", exportedObjects + "個  ->game->ExportedObj に 「"+ filename +"」 OBJを保存したよ" , "");
		}
		else
			EditorUtility.DisplayDialog("Objects not exported", "Make sure at least some of your selected objects have mesh filters!", "");
	}
